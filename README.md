Hi! Welcome to our repository! The aim of Clarity is to bridge the communication gap between us and those who may be blind or deaf.

Below is our source code for easy access and reading:
...
def organize_for_speech(array):
    ...
    if len(array)>0:
        ...
        text="Could not detect anything"
    return text
